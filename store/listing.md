...
**WallKraft** is a clean, fast, and private way to browse the Wallhaven
wallpaper library.
...
- Your Wallhaven API key is optional and stored only on your device
- Favorites are stored locally and never leave your phone

**Aesthetic**
- Material 3 design that follows your system theme (light, dark, or system)
- Optimized for speed and battery — only loads what you see

## Category
Photography (or: Personalization)
...
## Screenshots
`store/screenshots/` — 1-browse.png, 2-detail.png, 3-favorites.png, 4-settings.png (1080x2400)