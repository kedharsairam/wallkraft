...
- [x] **Prefetch detail image on tap** — warm the full-res image into the cache before the detail screen opens (added to the grid tap handler, covers Browse/Favorites).
